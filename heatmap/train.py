...
if __name__ == "__main__":
    ...
    datasets = KeyPointDatasets(root_dir=os.path.dirname(__file__)+"/data", transforms=transforms_all)
    ...
    for epoch in range(total_epoch):
        ...
        if epoch % 5 == 0:
            ptname = os.path.dirname(__file__)+"/weights/epoch_%d_%.3f.pt" % (epoch, loss*10000)
